...
export const ReportUnsecuredWebsites = svgIcon`
  <svg width="113" height="76" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="m93.236 44.384-18.42-11.026 2.93 21.266 5.582-5.237 4.27 6.46 2.98-1.971-4.26-6.446 6.918-3.046Z" fill="#7e17de" stroke="#fff" stroke-width="2" stroke-linejoin="round" />
